...
R, (x, a, b, c) =  K["x", "a", "b", "c"]
g = PolydiscFunction([(x-a)*(x-b)*(x-c)])
...
greedy_optim = greedy_descent_init(data, model, ell, 3)
...
display(greedy_optim.model.param.center)
display(greedy_optim.model.param.radius)
